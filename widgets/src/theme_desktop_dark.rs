...
live_design! {
    ...
    pub THEME_COLOR_TEXT_PLACEHOLDER_DISABLED = (THEME_COLOR_U_3)
    ...
    pub THEME_COLOR_BEVEL_DISABLED = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_OUTSET_2_DISABLED = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_SLIDER_HANDLE_1_DISABLED = #8
