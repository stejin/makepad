...
live_design! {
    ...
    pub THEME_COLOR_BEVEL_DOWN = (THEME_COLOR_U_4)
    pub THEME_COLOR_BEVEL_DISABLED = (THEME_COLOR_D_2)

    pub THEME_COLOR_BEVEL_1 = (THEME_COLOR_U_3)
    pub THEME_COLOR_BEVEL_1_DOWN = (THEME_COLOR_U_3)
    pub THEME_COLOR_BEVEL_1_HOVER = (THEME_COLOR_U_3 * 1.2)
    pub THEME_COLOR_BEVEL_1_FOCUS = (THEME_COLOR_U_3 * 1.3)
    pub THEME_COLOR_BEVEL_1_DRAG = (THEME_COLOR_U_3 * 1.2)
    pub THEME_COLOR_BEVEL_1_DISABLED = (THEME_COLOR_U_1)

    pub THEME_COLOR_BEVEL_2 = (THEME_COLOR_D_3)
    pub THEME_COLOR_BEVEL_2_DOWN = (THEME_COLOR_D_3)
    pub THEME_COLOR_BEVEL_2_HOVER = (THEME_COLOR_D_3)
    pub THEME_COLOR_BEVEL_2_FOCUS = (THEME_COLOR_D_4)
    pub THEME_COLOR_BEVEL_2_DRAG = (THEME_COLOR_D_4)
    pub THEME_COLOR_BEVEL_2_DISABLED = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_OUTSET_ACTIVE = (THEME_COLOR_U_1)
    pub THEME_COLOR_OUTSET_FOCUS = (THEME_COLOR_U_1)
    pub THEME_COLOR_OUTSET_DRAG = (THEME_COLOR_U_2)
    pub THEME_COLOR_OUTSET_DISABLED = (THEME_COLOR_U_HIDDEN)
    ...
    pub THEME_COLOR_OUTSET_1_ACTIVE = (THEME_COLOR_U_1)
    pub THEME_COLOR_OUTSET_1_FOCUS = (THEME_COLOR_U_1)
    pub THEME_COLOR_OUTSET_1_DRAG = (THEME_COLOR_U_2)
    ...
    pub THEME_COLOR_OUTSET_2_FOCUS = (THEME_COLOR_D_2)
    pub THEME_COLOR_OUTSET_2_DRAG = (THEME_COLOR_D_2)
    pub THEME_COLOR_OUTSET_2_DISABLED = (THEME_COLOR_D_1)
    pub THEME_COLOR_OUTSET_2_ACTIVE_FOCUS = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_MARK_ACTIVE_HOVER = (THEME_COLOR_U_6)
    pub THEME_COLOR_MARK_FOCUS = (THEME_COLOR_U_HIDDEN)
    pub THEME_COLOR_MARK_DISABLED = (THEME_COLOR_U_HIDDEN)
    ...
    pub THEME_COLOR_INSET_DOWN = (THEME_COLOR_D_3)
    ...
    pub THEME_COLOR_INSET_1_HOVER = (THEME_COLOR_D_3)
    pub THEME_COLOR_INSET_1_DOWN = (THEME_COLOR_D_5)
    pub THEME_COLOR_INSET_1_DRAG = (THEME_COLOR_D_5)
    pub THEME_COLOR_INSET_1_FOCUS = (THEME_COLOR_D_4)
    pub THEME_COLOR_INSET_1_ACTIVE = (THEME_COLOR_D_4)
    ...
    pub THEME_COLOR_INSET_2_DOWN = (THEME_COLOR_D_HIDDEN)
    pub THEME_COLOR_INSET_2_DRAG = (THEME_COLOR_D_HIDDEN)
    pub THEME_COLOR_INSET_2_FOCUS = (THEME_COLOR_D_HIDDEN)
    pub THEME_COLOR_INSET_2_ACTIVE = (THEME_COLOR_D_HIDDEN)
    ...
    pub THEME_COLOR_VAL_DRAG = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_ACTIVE = (THEME_COLOR_U_5)
    pub THEME_COLOR_VAL_DISABLED = (THEME_COLOR_U_2)

    pub THEME_COLOR_VAL_1 = (THEME_COLOR_U_3)
    pub THEME_COLOR_VAL_1_HOVER = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_1_FOCUS = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_1_DRAG = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_1_ACTIVE = (THEME_COLOR_U_5)
    pub THEME_COLOR_VAL_1_DISABLED = (THEME_COLOR_U_2)
    
    pub THEME_COLOR_VAL_2 = (THEME_COLOR_U_3)
    pub THEME_COLOR_VAL_2_HOVER = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_2_FOCUS = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_2_DRAG = (THEME_COLOR_U_4)
    pub THEME_COLOR_VAL_2_ACTIVE = (THEME_COLOR_U_5)
    pub THEME_COLOR_VAL_2_DISABLED = (THEME_COLOR_U_2)
    ...
    pub THEME_COLOR_VAL_TRACK_DISABLED = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_SLIDER_MINIMAL_HANDLE_FOCUS = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_HANDLE: (THEME_COLOR_U_3);
    pub THEME_COLOR_HANDLE_HOVER: (THEME_COLOR_U_4);
    pub THEME_COLOR_HANDLE_FOCUS: (THEME_COLOR_U_3);
    pub THEME_COLOR_HANDLE_DISABLED: (THEME_COLOR_U_3);
    pub THEME_COLOR_HANDLE_DRAG: (THEME_COLOR_U_2);
    ...
    pub THEME_COLOR_SLIDER_HANDLE_1 = #6
    pub THEME_COLOR_SLIDER_HANDLE_1 = #8
    pub THEME_COLOR_SLIDER_HANDLE_1_HOVER = #A
    pub THEME_COLOR_SLIDER_HANDLE_1_FOCUS = #8
    pub THEME_COLOR_SLIDER_HANDLE_1_DRAG = #8
    pub THEME_COLOR_SLIDER_HANDLE_1_DISABLED = #6

    pub THEME_COLOR_SLIDER_HANDLE_2 = #6
    pub THEME_COLOR_SLIDER_HANDLE_2 = #282828
    pub THEME_COLOR_SLIDER_HANDLE_2_HOVER = #3
    pub THEME_COLOR_SLIDER_HANDLE_2_FOCUS = #3
    pub THEME_COLOR_SLIDER_HANDLE_2_DRAG = #3
    pub THEME_COLOR_SLIDER_HANDLE_2_DISABLED = #3
