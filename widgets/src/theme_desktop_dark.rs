...
live_design! {
    ...
    pub THEME_COLOR_BEVEL_DISABLED = (#0ff)
    ...
    pub THEME_COLOR_BEVEL_LIGHT_DISABLED = (#0ff)
    ...
    pub THEME_COLOR_BEVEL_SHADOW_DISABLED = (#f00)
    ...
    pub THEME_COLOR_OUTSET_DISABLED = (#ff0)
    ...
    pub THEME_COLOR_OUTSET_1_DISABLED = (#ff0)
    ...
    pub THEME_COLOR_OUTSET_2_DISABLED = (#ff0)
    ...
    pub THEME_COLOR_MARK_DISABLED = (#0ff)
    ...
    pub THEME_COLOR_INSET_DISABLED = (#0ff)
    ...
    pub THEME_COLOR_INSET_1_DISABLED = (#ff0)
    ...
    pub THEME_COLOR_INSET_2_DISABLED = (#ff0)
    ...
    pub THEME_COLOR_VAL_DISABLED = (#f00)
    ...
    pub THEME_COLOR_VAL_TRACK_DISABLED = (#0f0)
    ...
    pub THEME_COLOR_SLIDER_HANDLE_1_DISABLED = #0f0
    ...
    pub THEME_COLOR_SLIDER_HANDLE_2_DISABLED = #00f
