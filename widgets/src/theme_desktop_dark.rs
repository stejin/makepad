...
live_design! {
    ...
    pub THEME_COLOR_BEVEL_LIGHT_DOWN = (THEME_COLOR_U_3)
    ...
    pub THEME_COLOR_BEVEL_LIGHT_DISABLED = (THEME_COLOR_U_1)

    pub THEME_COLOR_BEVEL_SHADOW = (THEME_COLOR_D_3)
    pub THEME_COLOR_BEVEL_SHADOW_DOWN = (THEME_COLOR_D_3)
    ...
    pub THEME_COLOR_BEVEL_SHADOW_DISABLED = (THEME_COLOR_D_2)
