...
live_design!{
    ...
    pub CheckBox = <CheckBoxBase> {
        ...
        draw_bg: {
            ...
            uniform border_color_1_active: (THEME_COLOR_BEVEL_2_ACTIVE)
            ...
            uniform border_color_2_down: (THEME_COLOR_BEVEL_DOWN)
            uniform border_color_2_active: (THEME_COLOR_BEVEL_1_ACTIVE)
