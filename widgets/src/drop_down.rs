...
live_design!{
    ...
    pub DropDown = <DropDownBase> {
        ...
        draw_bg: {
            ...
            uniform border_color_1_hover: (THEME_COLOR_BEVEL_1)
            uniform border_color_1_focus: (THEME_COLOR_BEVEL_1 * 1.3)
            uniform border_color_1_down: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_disabled: (THEME_COLOR_BEVEL_1)

            uniform border_color_2: (THEME_COLOR_BEVEL_2)
            uniform border_color_2_hover: (THEME_COLOR_BEVEL_2)
            uniform border_color_2_focus: (THEME_COLOR_BEVEL_2 * 1.3)
            uniform border_color_2_down: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_disabled: (THEME_COLOR_BEVEL_2)
    ...
    pub DropDownGradientX = <DropDown> {
        ...
        draw_bg: {
            ...
            uniform border_color_1_focus: (THEME_COLOR_BEVEL_1 * 1.3)
            uniform border_color_1_down: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_disabled: (THEME_COLOR_BEVEL_1 * 1.3)

            uniform border_color_2: (THEME_COLOR_BEVEL_2)
            uniform border_color_2_hover: (THEME_COLOR_BEVEL_2)
            uniform border_color_2_focus: (THEME_COLOR_BEVEL_2 * 1.3)
            uniform border_color_2_down: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_disabled: (THEME_COLOR_BEVEL_2 * 1.3)
