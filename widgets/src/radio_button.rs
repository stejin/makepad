...
live_design!{
    ...
    pub RadioButton = <RadioButtonBase> {
        ...
        draw_bg: {
            ...
            uniform border_color_1_down: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_active: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_focus: (THEME_COLOR_BEVEL_2_FOCUS)
            ...
            uniform border_color_2_down: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_active: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_focus: (THEME_COLOR_BEVEL_1_FOCUS)
            uniform border_color_2_disabled: (THEME_COLOR_BEVEL_1_DISABLED)

            uniform mark_color: (THEME_COLOR_U_HIDDEN)
            uniform mark_color_hover: (THEME_COLOR_INSET_HOVER)
            uniform mark_color_down: (THEME_COLOR_INSET_DOWN)
        ...
        draw_icon: {
            ...
            uniform color_1_down: (THEME_COLOR_TEXT_DOWN)
            ...
            uniform color_2_down: (THEME_COLOR_TEXT_DOWN)
    ...
    pub RadioButtonFlat = <RadioButton> {
        draw_bg: {
            ...
            border_color_1_down: (THEME_COLOR_INSET_DOWN)
            border_color_1_active: (THEME_COLOR_BEVEL)
            border_color_1_focus: (THEME_COLOR_BEVEL_1_FOCUS)
            border_color_1_disabled: (THEME_COLOR_BEVEL_2_DISABLED)
            ...
            border_color_2_focus: (THEME_COLOR_BEVEL_1_FOCUS)
            border_color_2_disabled: (THEME_COLOR_BEVEL_1_DISABLED)
    ...
    pub RadioButtonTab = <RadioButton> {
        ...
        draw_bg: {
            ...
            color_1_down: (THEME_COLOR_OUTSET_DOWN)
            ...
            color_2_down: (THEME_COLOR_OUTSET_DOWN)
            ...
            border_color_1_down: (THEME_COLOR_BEVEL_1)
            border_color_1_active: (THEME_COLOR_BEVEL_2)
            border_color_1_focus: (THEME_COLOR_BEVEL_2_FOCUS)
            border_color_1_disabled: (THEME_COLOR_BEVEL_2_DISABLED)

            border_color_2: (THEME_COLOR_BEVEL_2)
            border_color_2_hover: (THEME_COLOR_BEVEL_2)
            border_color_2_down: (THEME_COLOR_BEVEL_2)
            border_color_2_active: (THEME_COLOR_BEVEL_1)
            border_color_2_focus: (THEME_COLOR_BEVEL_1_FOCUS)
            border_color_2_disabled: (THEME_COLOR_BEVEL_1_DISABLED)
        }
    ...
    pub RadioButtonTabGradientX = <RadioButtonTab> {
        draw_bg: {
            ...
            uniform border_color_1: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_hover: (THEME_COLOR_BEVEL_2_HOVER)
            uniform border_color_1_down: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_active: (THEME_COLOR_BEVEL_2)
            uniform border_color_1_disabled: (THEME_COLOR_BEVEL_2_DISABLED)
            uniform border_color_1_active_focus: (THEME_COLOR_BEVEL_2_FOCUS)

            uniform border_color_2: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_hover: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_down: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_active: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_disabled: (THEME_COLOR_BEVEL_1)
            uniform border_color_2_active_focus: (THEME_COLOR_BEVEL_1_FOCUS)
