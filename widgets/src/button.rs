...
live_design! {
    ...
    pub Button = <ButtonBase> {
        ...
        draw_bg: {
            ...
            uniform border_color_1_down: (THEME_COLOR_BEVEL_1_DOWN)
            ...
            uniform border_color_2_down: (THEME_COLOR_BEVEL_1_DOWN)
    ...
    pub ButtonGradientX = <Button> {
        draw_bg: {
            ...
            border_color_1_hover: (THEME_COLOR_BEVEL_1_HOVER)
            border_color_1_down: (THEME_COLOR_BEVEL_1_DOWN)
            border_color_1_focus: (THEME_COLOR_BEVEL_1_FOCUS)
            border_color_1_disabled: (THEME_COLOR_BEVEL_1_DISABLED)

            border_color_2: (THEME_COLOR_BEVEL_2)
            border_color_2_hover: (THEME_COLOR_BEVEL_2_HOVER)
            border_color_2_down: (THEME_COLOR_BEVEL_2_DOWN)
            border_color_2_focus: (THEME_COLOR_BEVEL_2_FOCUS)
